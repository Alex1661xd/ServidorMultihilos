...
public final class ServidorWeb2 {
...
final class SolicitudHttp implements Runnable {
    ...
    private void proceseSolicitud() throws Exception {
        ...
        // Recoge y muestra las líneas del header (aunque no las usaremos).
        ...
        partesLinea.nextToken();  // Salta sobre el método "GET"
        String nombreArchivo = partesLinea.nextToken();

        // Agrega "." al inicio para indicar el directorio actual.
